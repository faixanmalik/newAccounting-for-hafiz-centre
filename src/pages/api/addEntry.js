...
export default async function handler(req, res) {
    ...
    if (req.method == 'POST'){
        ...
        // Expenses Invoice
            ...
            const { phoneNo, email, city, fromAccount, paidBy, project, dueDate, inputList, name,  memo, journalDate, journalNo, fullAmount, fullTax, totalAmount, attachment, path, importEntries, row } = req.body;

            let newEntry = new Expenses( { phoneNo, email, city, fromAccount, paidBy, project, dueDate, inputList, name,  memo, journalDate, journalNo, fullAmount, fullTax, totalAmount, attachment, type:path } );
            await newEntry.save();
            res.status(200).json({ success: true, message: "Entry Added !" }) 
        }
        ...
        // Receipt Voucher Invoice
            ...
            const { phoneNo, email, city, reference, amount, inputList, name,  memo, journalDate, journalNo, totalPaid, totalBalance, attachment, path, importEntries, row } = req.body;
            ...
            let newEntry = new ReceiptVoucher( { phoneNo, email, city, reference, amount, inputList, name,  memo, journalDate, journalNo, totalPaid, totalBalance, attachment, type:path } );
            await newEntry.save();
        ...
        // Debit Note Invoice
            ...
            const { phoneNo, email, city, fromAccount, paidBy, amount, dueDate, inputList, name,  memo, journalDate, journalNo, totalReceived, totalBalance, attachment, path, importEntries, row } = req.body;
            ...
            let newEntry = new DebitNote( { phoneNo, email, city, fromAccount, paidBy, amount, dueDate, inputList, name,  memo, journalDate, journalNo, totalReceived, totalBalance, attachment, type:path } );
            await newEntry.save();
        ...
        // Credit Note Invoice
            ...
            const { phoneNo, email, city, paidBy, amount, dueDate, inputList, name,  memo, journalDate, journalNo, totalReceived, totalBalance, attachment, path, importEntries, row } = req.body;
            ...
            let newEntry = new CreditNote( { phoneNo, email, city, paidBy, amount, dueDate, inputList, name,  memo, journalDate, journalNo, totalReceived, totalBalance, attachment, type:path } );
            await newEntry.save();
