      ...
      <div className="md:grid md:grid-cols-1 md:gap-6">
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0 flex">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Credit Notes</h3>
            <button
              type='button'
                            ...
                            <table className="w-full text-sm text-left text-gray-500 ">
                              ...
                              {filteredData && filteredData.map(( item , index)=>{
                                ...
                                return <tr key={index} className="bg-white text-black border-b hover:bg-gray-50">
                                  ...
                                  <td className="p-2">
                                    {item.amountPaid ? item.amountPaid.toLocaleString(): item.amountPaid.toLocaleString()}
                                  </td>
                                  <td className="p-2">
